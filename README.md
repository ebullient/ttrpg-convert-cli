...
2. Install the pre-built release: 
    ...
    ```shell
    jbang app install --name 5e-convert --force --fresh https://github.com/ebullient/json5e-convert-cli/releases/download/1.0.16/json5e-convert-cli-1.0.16-runner.jar
    ```
