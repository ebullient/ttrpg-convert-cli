...
2. Install the pre-built release: 
    ...
    ```shell
    jbang app install --name ttrpg-convert --force --fresh https://github.com/ebullient/ttrpg-convert-cli/releases/download/2.0.3/ttrpg-convert-cli-2.0.3-runner.jar
    ```
