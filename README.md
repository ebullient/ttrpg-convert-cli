...
2. Install the pre-built release: 
    ...
    ```shell
    jbang app install --name ttrpg-convert --force --fresh https://github.com/ebullient/ttrpg-convert-cli/releases/download/2.0.0/ttrpg-convert-cli-2.0.0-runner.jar
    ```
