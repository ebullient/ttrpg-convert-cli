...
1. From the [latest release][1], download the following files:
    ...
    - `ttrpg-convert-cli-3.2.3-windows-x86_64.zip`
    - `ttrpg-convert-cli-3.2.3-examples.zip`
...
ΓÅ▒∩╕Å Reading C:\Users\Kelly\Downloads\ttrpg-convert-cli-3.2.3-windows-x86_64\ttrpg-convert-cli-3.2.3-windows-x86_64\bin\5etools-mirror-2.github.io\data
...
⏱️ Reading C:\Users\Kelly\Downloads\ttrpg-convert-cli-3.2.3-windows-x86_64\ttrpg-convert-cli-3.2.3-windows-x86_64\bin\5etools-mirror-2.github.io\data
...
```shell
    Directory:
    C:\Users\Kelly\Downloads\ttrpg-convert-cli-3.2.3-windows-x86_64\ttrpg-convert-cli-3.2.3-windows-x86_64\bin
