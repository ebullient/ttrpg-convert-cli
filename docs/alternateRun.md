...
2. Download the CLI as a jar
    ...
    - Latest release: [ttrpg-convert-cli-3.0.1-runner.jar](https://github.com/ebullient/ttrpg-convert-cli/releases/download/3.0.1/ttrpg-convert-cli-3.0.1-runner.jar)
